defmodule Mix.Tasks.Compile.Asn1 do
  ...
  def clean do
    ...
    Enum.each(modules, fn mod ->
      Enum.each(module_files(Path.dirname(mod), Path.basename(mod)), &File.rm/1)
    end)
  ...
  defp extract_targets(src_dir, dest_dir, force) do
    ...
    {singleFileModules, moduleFiles} =
      Enum.reduce(file_sets, {files -- file_sets, []}, fn file, {files, targets} ->
